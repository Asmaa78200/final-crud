...
import HomeIcon from '@mui/icons-material/Home'; // Import de l'icône Home
    ...
    return (
        <Box >
            ...
            <Box sx={{ pb: 2, display: "flex", justifyContent: "right" }}>
                ...
                <Button variant='contained' color="primary" startIcon={<HomeIcon />}><Link style={{ color: 'white', textDecoration: 'none' }} to='/'>Home</Link> </Button>
            </Box>
